...
function findTown(){
    ...
    fetch ('https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q='+town+'&appid=1e82470e3c4cd294920473dfb28d4a3d&units=metric')
        ...
        .then(function(data){
            ...
            document.querySelector("#icon").innerHTML = '<img src="https://cors-anywhere.herokuapp.com/http://openweathermap.org/img/wn/'+data.weather[0].icon+'@2x.png">';
            //Current data
            CurrentData(data.dt)
            //Time of sunrise
...
function findTown2(){
    ...
    fetch ('https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q='+town2+'&appid=1e82470e3c4cd294920473dfb28d4a3d&units=metric')
        .then(function(resp){return resp.json()})
        .then(function(data){
